 ...
 * 
 * Displays game changelog with collapsible sections.
 * Uses dependency injection pattern for all external dependencies.
 */

/**
 * Creates a changelog modal renderer with injected dependencies
 * @param {Object} deps - Dependencies object
 * @returns {Object} Changelog modal API
 */
export function createChangelogModal(deps) {
     ...
     * @param {boolean} opts.fromPause - Whether opened from pause menu
     * @param {Function} opts.onBack - Custom back callback
     */
