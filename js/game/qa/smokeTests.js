 ...
 * 
 * Provides comprehensive smoke testing functionality for the game,
 * validating game mechanics, combat, equipment, and system integrity.
 */

export function createSmokeTestsRunner(dependencies) {
    // Extract all dependencies
    const {
        state, _diagnosticsUI, _engine,
        GAME_PATCH, GAME_PATCH_NAME, SAVE_SCHEMA,
        PLAYER_CLASSES, CLASS_STARTING_SKILLS, CLASS_LEVEL_UNLOCKS,
        ITEM_DEFS, ENEMY_TEMPLATES, ENEMY_ABILITIES,
        isUiDisabled, setUiDisabled, openModal, closeModal,
        qaCollectPerfSnapshotSync, qaFormatPerfSnapshotText,
        qaCollectBugScannerFindings, buildBugReportBundle,
        createDefaultQuestState, ensurePlayerSpellSystems,
        resetPlayerCombatStatus, recalcPlayerStats,
        ensurePlayerTalents, unlockTalent,
        ensureEnemyRuntime, applyEnemyAffixes,
        rebuildEnemyDisplayName, applyEquipmentOnPlayerHit,
        applyEquipmentOnShieldCast, applyEquipmentOnKill,
        buildEnemyForBattle, generateLootDrop,
        pickEnemyAbilitySet, playerBasicAttack,
        companionActIfPresent, rand, randInt,
        _saveTimerRef, _saveQueuedRef,
        updateHUDRef, updateEnemyPanelRef,
        handleEnemyDefeatRef, enemyTurnRef,
        handlePlayerDefeatRef, saveGameRef,
        // Additional dependencies from the smoke tests
        migrateSaveData, _buildSaveBlob, _setState,
        syncGlobalStateRef, createEmptyState, initRngState,
        setDeterministicRngEnabled, setRngSeed, initTimeState,
        initVillageEconomyState, initGovernmentState,
        ensureVillagePopulation, addItemToInventory,
        equipItemFromInventory, sellItemFromInventory,
        usePotionFromInventory, cloneItemDef, getSellValue,
        buildAbilityContext, ABILITY_EFFECTS, ABILITIES,
        TALENT_DEFS, COMPANION_ABILITIES, tickEnemyStartOfTurn,
        updateClassMeterHUD, computeElementSummariesForPlayer,
        normalizeElementType, validateState, formatIssues,
        qaScanAbilityElementCoverage, qaScanElementKeyIssues,
        ...
        applyStartOfTurnEffectsPlayer, applyPlayerRegenTick,
        beginPlayerTurn, ensureCombatTurnState, postEnemyTurn,
        ensureCombatPointers, exploreArea, canUseEnemyAbility,
        tickEnemyCooldowns, quests, advanceWorldTime
    } = dependencies
