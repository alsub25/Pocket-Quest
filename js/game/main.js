...
import { initBackendUI, showLoginScreen, shouldShowLoginScreen } from '../backend/backendUI.js'
...
initBackendUI().then((result) => {
  ...
  // Continue with game boot anyway - backend is optional
});
